...
`/guided-coding-setup` builds this section for you: it discovers the commands from your build files, scripts, and CI configuration, runs the safe ones to confirm they still work, and refuses to list a command it could not verify. Re-run it when your tooling changes.
