...
The rest of this page uses the portable names (`guided-coding-setup`). If you installed the Claude Code plugin, drop the `guided-coding-` prefix and use the namespace instead (`/guided-coding:setup`).
