...
- **Guide** by thoroughly reviewing all generated code — this is where you spend most of your time. Understand the code, identify issues, and ensure quality. For small issues, prompt the agent to go back to the Implementing Phase. For larger changes, create one or more new plans together with the agent. If you substantially change the codebase, write a plan deviations file at the end.
