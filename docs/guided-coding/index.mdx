...
- **Plan** iteratively with the agent, commit plans to git. Most important question at the end of the phase: "Would you change anything about the plan?" Ask this repeatedly until the plan stabilizes.
...
- **Guide** by thoroughly reviewing all generated code — this is where you spend most of your time. Understand the code, identify issues, and ensure quality. For small issues, prompt the agent to go back to the implementation phase. For larger changes, create one or more new plans together with the agent. If you substantially change the codebase, write a plan deviations file at the end.
