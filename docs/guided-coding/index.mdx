...
Callouts like this one show my concrete setup. This is the layer the [Guided Coding skills](https://github.com/feO2x/guided-coding) encode, and [Getting Started](./quick-start.mdx) walks through it end to end.
...
- Want to try the tooling right away? Start with [Getting Started](./quick-start.mdx).
