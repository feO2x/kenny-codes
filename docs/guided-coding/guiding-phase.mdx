...
The aim is a specific promise to whoever reviews the PR: **reading the issue's first plan and, when one exists, the Plan Deviations document is enough to understand the whole change.** [The Plan Record](./plan-record.md) covers what belongs in such a document.
