...
You can find all the AI plans, agents MD files, and the complete codebase at the [Light.PortableResults repository](https://github.com/feO2x/Light.Portable.Results). The full stream with Johannes is available on [YouTube](https://www.youtube.com/live/vopBYXp9YV0).
