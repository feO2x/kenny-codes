...
<svg viewBox="0 0 750 200" xmlns="http://www.w3.org/2000/svg" style={{maxWidth: '750px', width: '100%', margin: '1.5rem auto', display: 'block'}}>
  ...
  <path d="M 660 135 V 50 Q 660 25, 635 25 H 155 Q 130 25, 130 50 V 100" fill="none" stroke="#0078D4" strokeWidth="8" />
  <polygon points="130,130 112,100 148,100" fill="#0078D4" />
