---
title: "Writing Open Source Software in .NET"
date: 2018-12-10
type: Talk
duration: 2h
language: German
...
In this talk, we explore my open source library Light.GuardClauses and how I optimized certain features using Roslyn and source generators, Benchmark.NET, and the MSBuild multi-targeting system.
...
- How the library’s performance was optimized using Benchmark.NET
